...
![schematic of the network](https://github.com/jelub2/application/")
...
To check weather it's a good plan to go out for a ride the front-end side makes a XMLHttpRequest to the back-end server. In this case a NodeJS server.
...
Based on the received numbers the front-end side gives feedback weather to go out or not.
...
## Connection to WeatherAPI to get the weather procrastination of the location.  
